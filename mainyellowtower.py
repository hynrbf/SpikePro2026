...
class MissionYellowTower:
    ...
    async def exec_mission():
        ...
        await WheelController.move_backward(5)
        await multitask(HandController.lift_left(60, speed=Speed.Slow),
                        HandController.lift_right(60, speed=Speed.Slow))
        await multitask(WheelController.move_backward(90, Speed.Medium), HandController.lift_left(85),
                        HandController.lift_left(80))
